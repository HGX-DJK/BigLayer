/*!
 * ispace.biglayer v0.4.0
 * LICENSE : MIT
 * (c) 2016-2026 ispace.org
 */
/*!
 * requires ispace@>=0.37.0 
 */
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ispace')) :
	typeof define === 'function' && define.amd ? define(['exports', 'ispace'], factory) :
	(factory((global.ispace = global.ispace || {}),global.ispace));
}(this, (function (exports,ispace) { 'use strict';
...
var Painter = function (_ispace$Class) {
    inherits(Painter, _ispace$Class);

    function Painter(gl, map, options) {
        classCallCheck(this, Painter);

        var _this = possibleConstructorReturn(this, _ispace$Class.call(this, options));
...
var WebglRenderer = function (_ispace$renderer$Ca) {
    inherits(WebglRenderer, _ispace$renderer$Ca);

    function WebglRenderer() {
        classCallCheck(this, WebglRenderer);
        return possibleConstructorReturn(this, _ispace$renderer$Ca.apply(this, arguments));
    }
    ...
    WebglRenderer.prototype.needToRedraw = function needToRedraw() {
        ...
        return _ispace$renderer$Ca.prototype.needToRedraw.call(this);
    };

    WebglRenderer.prototype.mustRenderOnInteracting = function mustRenderOnInteracting() {
        return true;
    };
    ...
    WebglRenderer.prototype.createCanvas = function createCanvas() {
        ...
        _ispace$renderer$Ca.prototype.createCanvas.call(this);
    ...
    WebglRenderer.prototype.mergeSprites = function mergeSprites(sprites, forPoint) {
        ...
        var map = this.getMap();
        var spriteCanvas = this.layer._spriteCanvas || ispace.Canvas.createCanvas(w, h, map.CanvasClass),
    ...
    WebglRenderer.prototype._getLookAtMat = function _getLookAtMat() {
        ...
        var center2D = this.cameraCenter = map._prjToPoint(map._getPrjCenter(), targetZ);
    ...
    WebglRenderer.prototype.getCanvasImage = function getCanvasImage() {
        var canvasImg = _ispace$renderer$Ca.prototype.getCanvasImage.call(this);
    ...
    WebglRenderer.prototype.onZoomStart = function onZoomStart() {
        _ispace$renderer$Ca.prototype.onZoomStart.apply(this, arguments);
    };

    WebglRenderer.prototype.onZoomEnd = function onZoomEnd() {
        _ispace$renderer$Ca.prototype.onZoomEnd.apply(this, arguments);
    };

    WebglRenderer.prototype._createGLContext = function _createGLContext(canvas, options) {
        var attributes = ispace.Util.extend({
            'alpha': true,
            'antialias': true,
...
}(ispace.renderer.CanvasRenderer);
...
var LineAtlas = function () {
    ...
    LineAtlas.prototype.addAtlas = function addAtlas(symbol) {
        ...
        ispace.Canvas.prepareCanvas(ctx, symbol, this.resources);
...
var LinePainter = function (_Painter) {
    ...
    LinePainter.prototype.addLine = function addLine(line, style) {
        ...
        for (var _i = 0, _l = vertice.length; _i < _l; _i++) {
            ...
            if (this.options['project']) {
                vertex = this.map.coordinateToPoint(new ispace.Coordinate(vertex), targetZ).toArray();
            }
    ...
    LinePainter.prototype._addVertex = function _addVertex(currentVertex, normal, linesofar) {
        ...
        ispace.Util.pushIn(this.normalArray, normals);
        return n;
    };
    ...
    PolygonPainter.prototype.addPolygon = function addPolygon(polygon, style) {
        ...
        if (this.options['project']) {
            ...
            for (var _i = 0, _l = data.vertices.length; _i < _l; _i += 2) {
                c = this.map.coordinateToPoint(new ispace.Coordinate(data.vertices[_i], data.vertices[_i + 1]), targetZ);
                v.push(c.x, c.y);
            }
            data.vertices = v;
        }
        ...
        ispace.Util.pushIn(this.vertexArray, data.vertices);
        ispace.Util.pushIn(this.elementArray, triangles);
...
var maxUniformLength = ispace.Browser.ie || ispace.Browser.edge ? 504 : ispace.Util.IS_NODE ? 1014 : 240;
...
var BigDataLayer = function (_ispace$Layer) {
    inherits(BigDataLayer, _ispace$Layer);
    ...
    function BigDataLayer(id, data, options) {
        ...
        var opts = ispace.Util.extend({}, options);
        var style = void 0;
        if (opts['style']) {
            style = opts['style'];
            delete opts['style'];
        ...
        var _this = possibleConstructorReturn(this, _ispace$Layer.call(this, id, opts));
    ...
    BigDataLayer.prototype.setStyle = function setStyle(style) {
        ...
        this._style = style;
        this._cookedStyles = ispace.MapboxUtil.compileStyle(style);
    ...
    _class.prototype.checkResources = function checkResources() {
        ...
        if (this.layer.getStyle()) {
            this.layer.getStyle().forEach(function (s) {
                var res = ispace.Util.getExternalResources(s['symbol'], true);
                if (Array.isArray(res) && res.length > 0) {
                    if (Array.isArray(res[0])) {
                        ispace.Util.pushIn(resources, res);
                    } else {
                        resources.push(res);
                    }
                }
    ...
    _class.prototype._checkSprites = function _checkSprites() {
        ...
        if (this.layer.getStyle()) {
            ...
            this.layer.getStyle().forEach(function (style) {
                var marker = new ispace.Marker([0, 0], {
                    'symbol': style['symbol']
                });
...
var PathRenderer = function (_WebglRenderer) {
    ...
    PathRenderer.prototype.checkResources = function checkResources() {
        ...
        if (this.layer._cookedStyles) {
            this.layer._cookedStyles.forEach(function (s) {
                s['symbol'] = ispace.Util.convertResourceUrl(s['symbol']);
                var res = ispace.Util.getExternalResources(s['symbol'], true);
                if (res) {
                    resources.push(res);
                }
    ...
    PathRenderer.prototype._checkSprites = function _checkSprites() {
        ...
        if (this._sprites && typeof window != 'undefined' && window.ispace_WEBGL_DEBUG_CANVAS) {
            var debugCanvas = window.ispace_WEBGL_DEBUG_CANVAS;
...
var ExtrudePainter = function (_Painter) {
    ...
    ExtrudePainter.prototype._fillArrays = function _fillArrays(vertice, height, style) {
        ...
        for (var i = 0, l = data.vertices.length; i < l; i += 2) {
            ...
            if (this.options['project']) {
                c = this.map.coordinateToPoint(new ispace.Coordinate(data.vertices[i], data.vertices[i + 1]), targetZ);
        ...
        ispace.Util.pushIn(this.vertexArray, bottom);
        ...
        ispace.Util.pushIn(this.vertexArray, top);
...
typeof console !== 'undefined' && console.log('ispace.biglayer v0.4.0, requires ispace@>=0.37.0.');
